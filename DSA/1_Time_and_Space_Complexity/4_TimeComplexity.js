...
const goingUpDown=(n)=>{
    ...
    //here number of operation depends on 'n' i.e if n is 2 then 2 operations and so on
    for(let i=0;i<n;i++){ 
        console.log(i)
    }
    ...
    //here also number of operation depends on 'n' i.e if n is 2 then 2 operations and so on
    for(let j=n-1;j>=0;j--){
        console.log(j)
    }
